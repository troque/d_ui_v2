...
function TipoSujetoProcesalLista() {
    const [getTipoSujetoProcesalLista, setTipoSujetoProcesalLista] = useState({ data: [] });
    ...
    const [getRoutes, setRoutes] = useState({
        ...
        crear_registro: "/TipoSujetoProcesal/Add",
        consultar_registros: "/TipoSujetoProcesal",
        muestra_atras: false,
    ...
    const columns = [
        {
            name: 'NOMBRE',
            selector: TipoSujetoProcesal => TipoSujetoProcesal.attributes.nombre,
            sortable: true,
            width: "80%"
        },
        {
            name: 'ESTADO',
            selector: TipoSujetoProcesal => (TipoSujetoProcesal.attributes.estado == "1" ? 'ACTIVO' : 'INACTIVO'),
            sortable: true,
            width: "10%"
        },
        {
        ...
        async function fetchData() {
            ...
            GenericApi.getAllGeneric('tipo-sujeto-procesal').then(
                datos => {
                    ...
                    if (!datos.error) {
                        setTipoSujetoProcesalLista(datos);
                    }
                    else{
                        window.showModal()
                    }
            ...
            <div>
                    ...
                    <div className="w2d_block let">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb breadcrumb-alt push">
                                ...
                                <li className="breadcrumb-item"> <small>Tipos de sujeto procesal</small></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div className="block block-themed">
                    <div className="block-header">
                        <h3 className="block-title">ADMINISTRACIÓN :: TIPOS DE SUJETOS PROCESAL {getEstadoLista == global.Constants.ESTADOS.INACTIVO ? " INACTIVOS" : " ACTIVOS"}</h3>
                    ...
                    <div className="block-content">
                        ...
                        <div className="row">
                            ...
                            <DataTable className="table table-bordered table-striped table-vcenter js-dataTable-full"
                                    columns={columns}
                                    data={getTipoSujetoProcesalLista.data.filter((suggestion) => {
                                        if (getSeach === "") {
                                    ...
                                    paginationTotalRows={getTipoSujetoProcesalLista.data.length}
...
export default TipoSujetoProcesalLista;