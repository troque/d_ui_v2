...
async function getAllClasificacionRadicadoByFilter(data, procesoDisciplinarioId){

    const url = baseUrl + "clasificacion-radicado/get-clasificacion-radicado-filter/" + procesoDisciplinarioId;
    const token = getToken();
    headers['Authorization'] = `Bearer ${token}`;
    return await axios.post(url, data, {
        headers: headers
...
export default { addClasificacionRadicado, getAllClasificacionRadicadoByIdProDisciplinario, getClasificacionRadicado, getAllClasificacionRadicadoByFilter }
